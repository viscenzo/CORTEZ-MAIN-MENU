...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Anonymous",
   LoadingSubtitle = "Terminal Access: Granted.",
   ShowText = "Cortez", -- for mobile users to unhide rayfield, change if you'd like
   ...
   KeySettings = {
      Title = "Cortez",
      Subtitle = "Viscenzo detect you",
      Note = "Once we found out you leak it, we will disable your key", -- Use this to tell the user how to get a key
      FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"https://raw.githubusercontent.com/viscenzo/viscenzo-script/refs/heads/main/password"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
Rayfield:Notify({
   Title = "Cortez",
   Content = "The script is not shareable with others.",
   Duration = 10,
   Image = 4483362458,
})
...
if game.GameId == 113491250 then
	...
	local Window = DeleteMobLib:CreateWindow(HyperEscape.GUI.GUIToggleKey, "Cortez");
	...
	SettingsInfoSector:CreateCoppyText("Viscenzo");
	SettingsInfoSector:CreateCoppyText("https://discord.gg/ABA2Krb2");
...
spawn(function()
    ...
    if not (getgc and hookfunction and getrenv and debugInfo) then
        Notify("Anonymous", "Adonis whispered. The system obeyed.", 3)
        return
    end
...
local Window = Library.CreateLib("Viscenzo", "DarkTheme")
